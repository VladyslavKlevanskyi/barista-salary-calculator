...
urlpatterns = [
    ...
    path(
        "cafes/",
        CafeListView.as_view(),
        name="cafe-list-view"
    ),
    path(
        "cafes/<int:pk>/",
        CafeDetailView.as_view(),
        name="cafe-detail-view"
    ),
    path(
        "baristas/",
        BaristaListView.as_view(),
        name="barista-list-view"
    ),
    path(
        "baristas/<int:pk>/",
        BaristaDetailView.as_view(),
        name="barista-detail-view"
    ),
    path(
        "shifts/",
        ShiftListView.as_view(),
        name="shift-list-view"
    ),
    path(
        "shifts/create/",
